export const ContactInfo = () => {
  return (
    <div className="items-center box-border caret-transparent flex outline-[oklab(0.708_0_0_/_0.5)]">
      ...
      <button className="text-white text-sm font-medium items-center bg-gradient-to-r from-red-900 to-red-800 hover:from-red-800 hover:to-red-700 caret-transparent gap-x-2 flex shrink-0 h-9 justify-center leading-5 outline-[oklab(0.708_0_0_/_0.5)] gap-y-2 text-nowrap px-4 py-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg">
        Book Table
      </button>
    </div>
  );
