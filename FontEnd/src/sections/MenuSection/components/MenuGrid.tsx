    ...
    <div className="relative z-10">
      ...
      <div className="flex justify-center">
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 max-w-md mx-auto">
          ...
          <a href="/client/menu" className="bg-gradient-to-r from-red-900 to-red-800 text-white font-semibold px-6 py-3 rounded-xl transition-all">View menu</a>
        </div>
      </div>

      <div className="absolute -top-10 -left-10 w-32 h-32 bg-red-900/10 rounded-full blur-2xl"></div>
      <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-red-700/10 rounded-full blur-2xl"></div>
    </div>
  );
};
