    ...
    <div className="fixed box-border caret-transparent h-screen outline-[oklab(0.708_0_0_/_0.5)] overflow-auto inset-0">
      {/* Auth Button - Fixed in top right corner */}
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-red-900 to-red-800 text-white font-semibold rounded-lg hover:from-red-800 hover:to-red-700 transition-all shadow-lg hover:shadow-xl flex items-center gap-2"
        >
            ...
            <div className="relative text-white box-border caret-transparent max-w-4xl outline-[oklab(0.708_0_0_/_0.5)] text-center z-10 mx-auto px-4">
              ...
              <div className="box-border caret-transparent gap-x-4 flex flex-col justify-center outline-[oklab(0.708_0_0_/_0.5)] gap-y-4 md:flex-row">
                <button 
                  ...
                  className="text-white text-lg font-medium items-center bg-gradient-to-r from-red-900 to-red-800 hover:from-red-800 hover:to-red-700 caret-transparent gap-x-2 flex shrink-0 h-10 justify-center leading-7 outline-[oklab(0.708_0_0_/_0.5)] gap-y-2 text-left text-nowrap px-8 py-6 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Explore Restaurants
                </button>
                <button 
