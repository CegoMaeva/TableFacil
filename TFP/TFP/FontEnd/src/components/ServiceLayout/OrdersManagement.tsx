      ...
      <div className="card-elevated mb-6 bg-gradient-to-r from-neutral-800 to-neutral-900 border-2 border-brand-500/30">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end">
            <button
              onClick={fetchOrders}
              className="w-full px-4 py-3 bg-gradient-to-r from-brand-500 to-brand-600 hover:from-brand-600 hover:to-brand-700 text-white font-semibold rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg"
            >
              ...
              <div key={order.id} className="card-elevated hover:border-brand-500/50 transition-all">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="mb-3">
                      <h2 className="text-lg font-bold text-brand-300 mb-1">👤 {order.userName || 'Client'}</h2>
