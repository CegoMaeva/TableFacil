...
def upload_profile_photo():
    ...
    try:
        ...
        # Utiliser le chemin du fichier actuel pour trouver le bon répertoire
        current_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        uploads_dir = os.path.join(current_dir, 'static', 'uploads', 'avatars')
        ...
        print(f"Profil mis à jour pour user {user_id}: {url_path}")
